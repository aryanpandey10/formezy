...
export default function ThirdPartyApiContent() {
  return (
      ...
      <section className="relative pt-8 pb-10 md:pt-12 lg:pt-16">
        <div className="container-app">
          ...
          >
            ...
            <span className="text-[#2C0E3A]">Third-Party & APIs</span>
          </motion.nav>
          ...
          >
            ...
            >
              Connect Third-Party Platforms <br className="hidden sm:block" />
              <G>& APIs with Formezy</G>
            </motion.h1>
            <motion.p
              variants={fadeUp}
              className="mt-6 max-w-[840px] font-sora text-[16px] leading-[28px] text-[#6366A8] md:text-[18px]"
            >
              Integrate ERP systems, third-party platforms, communication tools, APIs, and operational workflows into one connected enterprise ecosystem.
            </motion.p>
            <motion.p
              variants={fadeUp}
              className="mt-6 font-sora text-[16px] leading-[28px] text-[#6366A8] md:text-[18px]"
            >
              <b>Unified Integrations for Connected Operations</b>
            </motion.p>
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
            ...
            >
              <div className="overflow-hidden rounded-[24px] border border-[#E8E4FF] bg-gradient-to-br from-[#EEF4FF] to-[#F5F0FF] p-2 shadow-sm">
                <Image
                  ...
                  alt="Key Challenges in Disconnected Systems"
                  width={600}
                  height={400}
            ...
            >
              ...
              <motion.p variants={fadeUp} className="font-sora text-[16px] leading-[28px] text-[#6366A8]">
                Businesses often operate across disconnected systems, fragmented workflows, and isolated operational tools, making coordination, visibility, and data consistency difficult across departments and processes.
              </motion.p>
              <motion.ul variants={staggerContainer} className="flex flex-col gap-4">
                {[
                  ...
                  "Delayed coordination across departments",
                  "Fragmented communication and workflows",
                  "Inconsistent reporting and synchronization",
                ].map((item) => (
                  <motion.li
                    key={item}
                    variants={fadeUp}
      ...
      <section className="section bg-[#F8F9FF]/50">
        <div className="container-app">
          ...
          >
            ...
            >
              What are Third-Party & <G>API Integrations?</G>
            </motion.h2>
            <motion.p
              variants={fadeUp}
              className="mx-auto mt-4 max-w-[800px] font-sora text-[16px] leading-[28px] text-[#6366A8]"
            >
              Third-party and API integrations connect business systems, workflows, communication platforms, and operational data into one unified ecosystem to improve visibility, coordination, and execution.
            </motion.p>
            ...
            <div className="flex flex-wrap justify-center gap-x-8 gap-y-3 max-w-4xl mx-auto mb-8">
              {[
                ...
                "Third-party business application connectivity",
          ...
          >
            <Image
              ...
              alt="API integrations Concept Diagram"
              width={1200}
              height={600}
            ...
            {[
              {
                ...
                desc: "Connect enterprise systems, applications, and operational tools through secure and scalable APIs.",
              },
              {
                title: "Third-Party Platform Connectivity",
                desc: "Integrate accounting systems, ERP platforms, communication tools, reporting systems, and business applications.",
              },
              {
                title: "Workflow & Data Synchronization",
                desc: "Synchronize operational workflows, approvals, updates, and business data across connected systems.",
              },
              {
                title: "Real-Time Operational Visibility",
                desc: "Enable centralized dashboards and reporting visibility across integrated operations.",
              },
            ].map((cap) => (
              <div
                key={cap.title}
            ...
            <div className="rounded-[30px] border border-[#9D94EF] p-8 md:p-[50px] shadow-sm flex flex-col justify-between bg-white">
              <div>
                ...
                <p className="mt-4 font-sora text-[15px] leading-[26px] text-[#6F6C90] mb-6">
                  Formezy EAP enables businesses to connect internal and external systems through scalable integrations, workflow synchronization, operational visibility, and centralized coordination.
                </p>
                ...
                <div className="mt-8 space-y-6">
                  <div>
                    ...
                    <div className="mt-2 text-[14px] font-sora text-[#6F6C90]">
                      External Platform → API Integration → Workflow Trigger → Approval → Reporting
                    </div>
                  </div>
                  <div>
                    <h4 className="font-sora text-[16px] font-bold text-[#1D0629]">
                    ...
                    <div className="mt-2 text-[14px] font-sora text-[#6F6C90]">
                      Order Creation → ERP Sync → Inventory Update → Notification → Dashboard Visibility
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="grid gap-8 lg:grid-cols-2 items-center">
              <div className="flex flex-col gap-4">
                ...
                <h2 className="font-sora text-[32px] font-bold leading-[1.15] text-[#2C0E3A] md:text-[44px]">
                  Unifying Your <G>Data Ecosystem</G>
                </h2>
              </div>
              <div className="flex flex-col gap-4">
                <ul className="space-y-3">
                  {[
                    ...
                    "Workflow-driven operational connectivity",
          ...
          >
            <div className="relative z-10 px-6">
              <h2 className="mx-auto max-w-[800px] font-sora text-[32px] font-bold leading-[1.2] text-[#2C0E3A] md:text-[44px]">
                Build a Connected Enterprise <G>Ecosystem with Formezy</G>
              </h2>
            ...
            <div className="mt-12 overflow-hidden px-4 md:px-12 lg:px-20">
              <Image
                ...
                alt="Third-Party CTA Illustration"
                width={1200}
                height={600}
