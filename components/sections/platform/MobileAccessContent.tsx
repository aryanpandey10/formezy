...
function HeroSection() {
  return (
    <PlatformFeatureHero
      ...
      description={
        <p>
          Formezy mobile access puts approvals, workflows, and operational data in
          your pocket — so teams stay connected and in control from anywhere.
        </p>
      }
