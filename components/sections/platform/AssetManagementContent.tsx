...
import { assetManagementWebp } from "@/lib/use-case-webp";
    ...
    <div className="flex flex-col gap-0 overflow-hidden">
      ...
      <section className="relative pt-8 pb-10 md:pt-12 lg:pt-16">
        <div className="container-app">
          <PlatformBreadcrumb currentLabel="Asset Management System" />
          ...
          >
            ...
            >
              ...
              <G>Asset Management System for Your Business</G>
            </motion.h1>
            <motion.p
              variants={fadeUp}
              className="mt-6 max-w-[840px] font-sora text-[16px] leading-[28px] text-[#6366A8] md:text-[18px]"
            >
              Track, manage, and maintain assets with structured workflows, real-time visibility, and centralized operational control.
            </motion.p>
            <motion.p
              variants={fadeUp}
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
            ...
            >
              <div className="overflow-hidden rounded-[24px] border border-[#E8E4FF] bg-gradient-to-br from-[#EEF4FF] to-[#F5F0FF] p-2 shadow-sm">
                <Image
                  src={assetManagementWebp.businessChallenges}
            ...
            >
              ...
              <motion.p variants={fadeUp} className="font-sora text-[16px] leading-[28px] text-[#6366A8]">
                Managing assets across disconnected systems creates inefficiencies, downtime, and limited visibility into maintenance and operational activities.
              </motion.p>
              <motion.ul variants={staggerContainer} className="flex flex-col gap-4">
                {[
                  "Limited visibility into asset utilization and status",
                  "Manual maintenance and servicing coordination",
                  "Delays in inspections and operational tracking",
                  "Difficulty managing assets across locations",
                  "Lack of centralized maintenance visibility",
                ].map((item) => (
                  <motion.li
                    key={item}
                    variants={fadeUp}
      ...
      {/* ── Section 3: What Is a Tailored Asset System ── */}
      <section className="section bg-[#F8F9FF]/50">
        <div className="container-app">
          ...
          >
            ...
            >
              What Is a <G>Asset Management System</G>
            </motion.h2>
            <motion.p
              variants={fadeUp}
              className="mx-auto mt-6 max-w-[900px] font-sora text-[16px] leading-[28px] text-[#6366A8]"
            >
              A tailored Asset Management System is built around how your business manages assets, maintenance workflows, inspections, and operational tracking.
            </motion.p>
            <motion.p
              variants={fadeUp}
              className="mx-auto mt-6 max-w-[900px] font-sora text-[16px] leading-[28px] text-[#6366A8]"
            >
              It helps businesses streamline asset operations, improve maintenance visibility, and ensure structured lifecycle management.
            </motion.p>
            ...
            <div className="flex flex-wrap justify-center gap-x-8 gap-y-3 max-w-4xl mx-auto mb-8">
              {[
                "Asset lifecycle and utilization tracking",
                "Preventive and corrective maintenance workflows",
                "Inspection and servicing management",
          ...
          >
            <Image
              src={assetManagementWebp.whatIs}
              alt="Asset Management Concept"
              width={1200}
              height={600}
        ...
        <div className="container-app">
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
            ...
            >
              ...
              <motion.p variants={fadeUp} className="font-sora text-[16px] leading-[28px] text-[#6366A8]">
                Formezy allows you to build an asset management system that aligns with your operational and maintenance workflows.
              </motion.p>
              <motion.ul variants={staggerContainer} className="flex flex-col gap-4">
                {[
                  "Low-code customization for asset workflows",
                  "Automation across maintenance and inspection processes",
                  "Role-based access for operations and maintenance teams",
                  "Integration with inventory, operations, and reporting systems",
                ].map((item) => (
                  <motion.li
                    key={item}
                    variants={fadeUp}
            ...
            >
              <div className="overflow-hidden rounded-[24px] border border-[#E8E4FF] bg-white p-2 shadow-sm">
                <Image
                  src={assetManagementWebp.howFormezyEnables}
                  alt="How Formezy Enables Asset Management"
                  width={600}
                  height={400}
                  className="h-auto w-full rounded-[18px]"
                />
        ...
        <div className="container-app">
          ...
          >
            ...
            <motion.p
              ...
              className="mx-auto mt-6 max-w-[900px] font-sora text-[16px] leading-[28px] text-[#6366A8]"
            >
              See how a tailored asset management system works in a real business scenario:
            </motion.p>
            ...
            <div className="flex flex-wrap justify-center gap-x-8 gap-y-3 max-w-4xl mx-auto mt-4 mb-8">
              {[
                "Asset allocated and operationally tracked",
                "Maintenance request generated automatically",
                "Inspection and servicing workflows initiated",
                "Asset updated and returned to operations",
              ].map((step, idx) => (
                <span
                  key={step}
          ...
          >
            <Image
              src={assetManagementWebp.realWorkflow}
              alt="Real Asset Workflow Diagram"
              width={1200}
              height={500}
              className="h-auto w-full"
            />
          ...
          <div className="grid grid-cols-1 gap-10 md:grid-cols-2">
            ...
            <div className="rounded-[30px] border border-[#9D94EF] p-8 md:p-[50px] shadow-sm flex flex-col justify-between">
              <div>
                ...
                <p className="mt-6 font-sora text-[15px] leading-[26px] text-[#6F6C90]">
                  With Formezy, your asset management system becomes fully connected and operationally streamlined.
                </p>
                <ul className="mt-8 space-y-4">
                  {[
                    "Asset tracking and lifecycle management",
                    "Maintenance and servicing workflows",
                    "Inspection and operational coordination",
            ...
            <div className="rounded-[30px] border border-[#9D94EF] p-8 md:p-[50px] shadow-sm flex flex-col justify-between">
              <div>
                ...
                <p className="mt-6 font-sora text-[15px] leading-[26px] text-[#6F6C90]">
                  Formezy enables asset systems across industries that rely on structured maintenance and operational visibility.
                </p>
                <ul className="mt-8 space-y-4">
                  {[
            ...
            <div className="rounded-[30px] border border-[#9D94EF] p-8 md:p-[50px] shadow-sm flex flex-col justify-between">
              <div>
                ...
                <p className="mt-6 font-sora text-[15px] leading-[26px] text-[#6F6C90]">
                  A tailored Asset Management System improves visibility, maintenance coordination, and operational efficiency.
                </p>
                <ul className="mt-8 space-y-4">
                  {[
                    "Reduced operational downtime",
                    "Improved asset utilization visibility",
                    "Faster maintenance and inspection coordination",
            ...
            <div className="rounded-[30px] border border-[#9D94EF] p-8 md:p-[50px] shadow-sm flex flex-col justify-between">
              <div>
                ...
                <p className="mt-6 font-sora text-[15px] leading-[26px] text-[#6F6C90]">
                  Formezy enables asset systems that are scalable, connected, and workflow-driven.
                </p>
                <ul className="mt-8 space-y-4">
                  {[
                    "Built on an Enterprise Application Platform (EAP)",
                    "Fully customizable to your asset workflows",
                    "Faster implementation and flexibility",
                    "Systems that evolve with your operational needs",
                  ].map((item) => (
                    <li key={item} className="flex items-start gap-3">
                      <span className="mt-2 h-2.5 w-2.5 shrink-0 rounded-full bg-[#9D94EF]" />
                      <p className="font-sora text-[15px] leading-[24px] text-[#6F6C90]">
          ...
          >
            <div className="relative z-10 px-6">
              <h2 className="mx-auto max-w-[800px] font-sora text-[32px] font-bold leading-[1.2] text-[#2C0E3A] md:text-[44px]">
                Improve Asset Visibility <G>and Maintenance Operations</G>
              </h2>
              <p className="mx-auto mt-4 max-w-[600px] font-sora text-[16px] text-[#6366A8]">
                Build a connected asset management system designed around your operations.
              </p>
            ...
            <div className="mt-12 overflow-hidden px-4 md:px-12 lg:px-20">
              <Image
                src={assetManagementWebp.cta}
                alt="Build an Asset Management System Illustration"
                width={1200}
                height={600}
