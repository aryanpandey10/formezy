...
import { rentalIndustryWebp } from "@/lib/use-case-webp";
...
export default function RentalIndustryContent() {
  return (
    <div className="flex flex-col gap-0 overflow-hidden">
      ...
      <section className="relative pt-8 pb-10 md:pt-12 lg:pt-16">
        <div className="container-app">
          ...
          >
            ...
            >
              Connected Rental <br className="hidden sm:block" />
            ...
            >
              Manage rental workflows, asset tracking, agreements, inventory visibility, maintenance coordination, and operational execution through one connected rental management platform.
            </motion.p>
            <motion.p
              variants={fadeUp}
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
            ...
            >
              <div className="overflow-hidden rounded-[24px] border border-[#E8E4FF] bg-gradient-to-br from-[#EEF4FF] to-[#F5F0FF] p-2 shadow-sm">
                <Image
                  src={rentalIndustryWebp.businessChallenges}
                  alt="Rental Industry Challenges"
                  width={600}
                  height={400}
            ...
            >
              ...
              >
                Rental Industry <G>Challenges</G>
              </motion.h2>
              <motion.p variants={fadeUp} className="font-sora text-[16px] leading-[28px] text-[#6366A8]">
                Rental businesses often struggle with scattered asset tracking, delayed coordination, manual agreement management, and limited visibility across rented assets, inventory, maintenance, and operational workflows.
              </motion.p>
              <motion.ul variants={staggerContainer} className="flex flex-col gap-4">
                {[
                  "Limited rental asset visibility",
                  "Manual agreement and tracking processes",
                  "Delayed maintenance coordination",
                  "Inventory and availability mismatches",
                  "Poor operational visibility across locations",
                  "Disconnected customer and operational workflows",
                ].map((item) => (
                  <motion.li
                    key={item}
                    variants={fadeUp}
      ...
      {/* ── Section 3: Rental Operations with Formezy ── */}
      <section className="section bg-[#F8F9FF]/50">
        <div className="container-app">
          ...
          >
            ...
            >
              Rental Operations <G>with Formezy</G>
            </motion.h2>
            <motion.p
              variants={fadeUp}
              className="mx-auto mt-6 max-w-[900px] font-sora text-[16px] leading-[28px] text-[#6366A8]"
            >
              Formezy helps rental businesses streamline rental workflows, asset utilization, inventory coordination, maintenance tracking, and operational visibility through centralized and workflow-driven systems.
            </motion.p>
            ...
            <div className="flex flex-wrap justify-center gap-x-8 gap-y-3 max-w-4xl mx-auto mb-8">
              {[
                ...
                "Agreement and workflow management",
          ...
          >
            <Image
              src={rentalIndustryWebp.whatIs}
              alt="Rental Operations Concept"
              width={1200}
              height={600}
      ...
      {/* ── Section 4: Rental Industry Verticals ── */}
        ...
        <div className="container-app">
          ...
          >
            <motion.h2
              ...
              className="font-sora text-[32px] font-bold leading-[1.2] text-[#2C0E3A] md:text-[40px]"
            >
              Tailored for Every <G>Rental Industry Vertical</G>
            </motion.h2>
          </motion.div>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-2 max-w-5xl mx-auto">
            {[
              {
                title: "Equipment & Machinery Rentals",
                desc: "Manage rental assets, maintenance workflows, agreements, and operational visibility across industrial and equipment rental operations.",
                points: [
                  "Real-time asset tracking",
                  "Improved maintenance coordination",
                  "Better utilization visibility",
                  "Centralized rental workflows",
                ],
              },
              {
                title: "Commodity & Material Rentals",
                desc: "Digitize inventory movement, rental coordination, dispatch workflows, and availability tracking across commodity rental operations.",
                points: [
                  "Better inventory visibility",
                  "Faster operational coordination",
                  "Improved dispatch tracking",
                  "Centralized workflow management",
                ],
              },
              {
                title: "Vehicle & Mobility Rentals",
                desc: "Manage fleet allocation, maintenance workflows, operational visibility, and rental coordination through connected operational systems.",
                points: [
                  "Improved fleet visibility",
                  "Better maintenance tracking",
                  "Faster rental coordination",
                  "Real-time operational updates",
                ],
              },
              {
                title: "Event & Infrastructure Rentals",
                desc: "Streamline booking workflows, inventory allocation, operational tracking, and customer coordination for event and infrastructure rental businesses.",
                points: [
      ...
      {/* ── Section 5: How Formezy Enables Rental Operations ── */}
            ...
            <div className="rounded-[30px] border border-[#9D94EF] p-8 md:p-[50px] shadow-sm flex flex-col justify-between bg-white">
              <div>
                <h3 className="font-sora text-[28px] font-bold leading-[38px] text-[#1D0629] sm:text-[34px] lg:text-[38px]">
                  ...
                  <span className="text-[#6C63FF]">Rental Operations</span>
                </h3>
                <ul className="mt-8 space-y-4">
                  {[
                    "Workflow-driven rental coordination",
            ...
            <div className="grid gap-8 lg:grid-cols-2 items-center">
              <div className="flex flex-col gap-4">
                ...
                <h2 className="font-sora text-[32px] font-bold leading-[1.15] text-[#2C0E3A] md:text-[44px]">
                  An Enterprise Platform <G>for Rental Operations</G>
                </h2>
              </div>
              <div className="flex flex-col gap-4">
                <ul className="space-y-3">
                  {[
                    "Tailored rental workflows",
          ...
          >
            <div className="relative z-10 px-6">
              <h2 className="mx-auto max-w-[800px] font-sora text-[32px] font-bold leading-[1.2] text-[#2C0E3A] md:text-[44px]">
                Simplify Rental Operations <G>with Formezy</G>
              </h2>
            ...
            <div className="mt-12 overflow-hidden px-4 md:px-12 lg:px-20">
              <Image
                src={rentalIndustryWebp.cta}
                alt="Rental CTA Illustration"
                width={1200}
                height={600}
