...
import { humanResourcesWebp } from "@/lib/use-case-webp";
    ...
    <div className="flex flex-col gap-0 overflow-hidden">
      ...
      <section className="relative pt-8 pb-10 md:pt-12 lg:pt-16">
        <div className="container-app">
          <PlatformBreadcrumb currentLabel="Human Resources Management System" />
          ...
          >
            ...
            >
              ...
              <G>Human Resources Management System for Your Business</G>
            </motion.h1>
            <motion.p
              variants={fadeUp}
              className="mt-6 max-w-[840px] font-sora text-[16px] leading-[28px] text-[#6366A8] md:text-[18px]"
            >
              Manage employee workflows, attendance, approvals, communication, and workforce operations with structured processes and centralized visibility.
            </motion.p>
            <motion.p
              variants={fadeUp}
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
            ...
            >
              <div className="overflow-hidden rounded-[24px] border border-[#E8E4FF] bg-gradient-to-br from-[#EEF4FF] to-[#F5F0FF] p-2 shadow-sm">
                <Image
                  src={humanResourcesWebp.businessChallenges}
            ...
            >
              ...
              <motion.p variants={fadeUp} className="font-sora text-[16px] leading-[28px] text-[#6366A8]">
                Managing workforce operations across disconnected systems creates inefficiencies, delays, and limited visibility into employee activities and HR workflows.
              </motion.p>
              <motion.ul variants={staggerContainer} className="flex flex-col gap-4">
                {[
                  "Manual attendance and employee tracking",
                  "Delayed HR approvals and communication",
                  "Limited visibility into workforce operations",
                  "Disconnected employee records and workflows",
                  "Difficulty managing multi-location teams",
                ].map((item) => (
                  <motion.li
                    key={item}
                    variants={fadeUp}
      ...
      {/* ── Section 3: What Is a Tailored HR System ── */}
      <section className="section bg-[#F8F9FF]/50">
        <div className="container-app">
          ...
          >
            ...
            >
              What Is a <G>Human Resources Management System</G>
            </motion.h2>
            <motion.p
              variants={fadeUp}
              className="mx-auto mt-6 max-w-[900px] font-sora text-[16px] leading-[28px] text-[#6366A8]"
            >
              A tailored Human Resources Management System is built around how your business manages employees, attendance, approvals, and workforce coordination.
            </motion.p>
            <motion.p
              variants={fadeUp}
              className="mx-auto mt-6 max-w-[900px] font-sora text-[16px] leading-[28px] text-[#6366A8]"
            >
              It helps businesses streamline HR workflows, improve workforce visibility, and maintain structured employee operations.
            </motion.p>
            ...
            <div className="flex flex-wrap justify-center gap-x-8 gap-y-3 max-w-4xl mx-auto mb-8">
              {[
                "Employee record and attendance management",
                "HR approval workflows",
                "Leave and request management",
                "Workforce reporting and operational visibility",
              ].map((cap) => (
                <span
                  key={cap}
          ...
          >
            <Image
              src={humanResourcesWebp.whatIs}
              alt="HR Management Concept"
              width={1200}
              height={600}
        ...
        <div className="container-app">
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
            ...
            >
              ...
              <motion.p variants={fadeUp} className="font-sora text-[16px] leading-[28px] text-[#6366A8]">
                Formezy allows you to build an HR management system that aligns with your workforce operations and organizational workflows.
              </motion.p>
              <motion.ul variants={staggerContainer} className="flex flex-col gap-4">
                {[
                  "Low-code customization for HR workflows",
                  "Automation across approvals and employee operations",
                  "Role-based access for HR and management teams",
                  "Integration with attendance, payroll, and operational systems",
                ].map((item) => (
                  <motion.li
                    key={item}
                    variants={fadeUp}
            ...
            >
              <div className="overflow-hidden rounded-[24px] border border-[#E8E4FF] bg-white p-2 shadow-sm">
                <Image
                  src={humanResourcesWebp.howFormezyEnables}
                  alt="How Formezy Enables HR Management"
                  width={600}
                  height={400}
                  className="h-auto w-full rounded-[18px]"
                />
        ...
        <div className="container-app">
          ...
          >
            ...
            <motion.p
              ...
              className="mx-auto mt-6 max-w-[900px] font-sora text-[16px] leading-[28px] text-[#6366A8]"
            >
              See how a tailored HR management system works in a real business scenario:
            </motion.p>
            ...
            <div className="flex flex-wrap justify-center gap-x-8 gap-y-3 max-w-4xl mx-auto mt-4 mb-8">
              {[
                "Employee request submitted through workflow",
                "Approval process initiated automatically",
                "HR team processes request and updates records",
          ...
          >
            <Image
              src={humanResourcesWebp.realWorkflow}
              alt="Real HR Workflow Diagram"
              width={1200}
              height={500}
              className="h-auto w-full"
            />
          ...
          <div className="grid grid-cols-1 gap-10 md:grid-cols-2">
            ...
            <div className="rounded-[30px] border border-[#9D94EF] p-8 md:p-[50px] shadow-sm flex flex-col justify-between">
              <div>
                ...
                <p className="mt-6 font-sora text-[15px] leading-[26px] text-[#6F6C90]">
                  With Formezy, your HR management system becomes fully connected and operationally streamlined.
                </p>
                <ul className="mt-8 space-y-4">
                  {[
                    "Employee records and workforce visibility",
                    "Attendance and leave management workflows",
                    "HR approvals and communication coordination",
                    "Multi-location workforce operations",
                    "Centralized HR dashboards and reporting",
                  ].map((item) => (
            ...
            <div className="rounded-[30px] border border-[#9D94EF] p-8 md:p-[50px] shadow-sm flex flex-col justify-between">
              <div>
                ...
                <p className="mt-6 font-sora text-[15px] leading-[26px] text-[#6F6C90]">
                  Formezy enables HR systems across industries that rely on structured workforce operations and employee coordination.
                </p>
                <ul className="mt-8 space-y-4">
                  {[
                    ...
                    "Service and enterprise businesses",
                  ].map((item) => (
                    <li key={item} className="flex items-start gap-3">
                      <span className="mt-2 h-2.5 w-2.5 shrink-0 rounded-full bg-[#9D94EF]" />
                      <p className="font-sora text-[15px] leading-[24px] text-[#6F6C90]">
            ...
            <div className="rounded-[30px] border border-[#9D94EF] p-8 md:p-[50px] shadow-sm flex flex-col justify-between">
              <div>
                ...
                <p className="mt-6 font-sora text-[15px] leading-[26px] text-[#6F6C90]">
                  A tailored Human Resources Management System improves coordination, visibility, and workforce operational efficiency.
                </p>
                <ul className="mt-8 space-y-4">
                  {[
                    "Faster HR operations and approvals",
                    "Improved workforce visibility and coordination",
                    "Better employee communication and tracking",
                    "Reduced manual HR management processes",
                  ].map((item) => (
                    <li key={item} className="flex items-start gap-3">
                      <span className="mt-2 h-2.5 w-2.5 shrink-0 rounded-full bg-[#9D94EF]" />
                      <p className="font-sora text-[15px] leading-[24px] text-[#6F6C90]">
            ...
            <div className="rounded-[30px] border border-[#9D94EF] p-8 md:p-[50px] shadow-sm flex flex-col justify-between">
              <div>
                ...
                <p className="mt-6 font-sora text-[15px] leading-[26px] text-[#6F6C90]">
                  Formezy enables HR systems that are scalable, connected, and workflow-driven.
                </p>
                <ul className="mt-8 space-y-4">
                  {[
                    ...
                    "Systems that evolve with your workforce operations",
                  ].map((item) => (
                    <li key={item} className="flex items-start gap-3">
                      <span className="mt-2 h-2.5 w-2.5 shrink-0 rounded-full bg-[#9D94EF]" />
                      <p className="font-sora text-[15px] leading-[24px] text-[#6F6C90]">
          ...
          >
            <div className="relative z-10 px-6">
              <h2 className="mx-auto max-w-[800px] font-sora text-[32px] font-bold leading-[1.2] text-[#2C0E3A] md:text-[44px]">
                Simplify Workforce <G>and HR Operations</G>
              </h2>
              <p className="mx-auto mt-4 max-w-[600px] font-sora text-[16px] text-[#6366A8]">
                Build a connected HR management system designed around your business operations.
              </p>
            ...
            <div className="mt-12 overflow-hidden px-4 md:px-12 lg:px-20">
              <Image
                src={humanResourcesWebp.cta}
                alt="Build a Human Resources System Illustration"
                width={1200}
                height={600}
